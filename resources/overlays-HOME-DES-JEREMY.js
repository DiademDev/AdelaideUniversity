...
export function addRings(viewer, store) {
    ...
    addRing({
        ...
        ellipse: { semiMinorAxis: 500, semiMajorAxis: 500, material: Cesium.Color.WHITE.withAlpha(0.45) },
        show: false
    });

    addRing({
        position: Cesium.Cartesian3.fromDegrees(0, 0, 0),
        ellipse: { semiMinorAxis: 1000, semiMajorAxis: 1000, material: Cesium.Color.WHITE.withAlpha(0.25) },
        show: false
    });

    addRing({
        position: Cesium.Cartesian3.fromDegrees(0, 0, 0),
        ellipse: { semiMinorAxis: 1500, semiMajorAxis: 1500, material: Cesium.Color.ORANGE.withAlpha(0.25) },
        show: false
    });
